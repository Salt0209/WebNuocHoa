<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuochoaCalvin.aspx.cs" Inherits="myBTL.NuochoaCalvin" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="Style\NuochoaCalvin.css" />
...
<body>
    <form id="form1" runat="server">
        ...
        <%--        Main--%>
        <div id="main">
            <h2 id="h2" runat="server">Nước hoa Calvin Klein
