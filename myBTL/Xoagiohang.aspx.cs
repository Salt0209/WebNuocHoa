...
namespace myBTL
{
    public partial class Xoagiohang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string cartCookies = Request.Cookies["giohang"].Value;
            ...
            Response.Cookies["giohang"].Value = newCookiesAfterDeletedProduct;
            Response.Cookies["giohang"].Expires = DateTime.Now.AddDays(12);
