<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sanphamtimkiem.aspx.cs" Inherits="myBTL.sanphamtimkiem" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="Style\Nuochoanu.css" />
...
<body>
    <form id="form1" runat="server">
        ...
        <%--        Main--%>
        <div id="main">
            <h2 id="h2" runat="server">Tìm kiếm sản phẩm
